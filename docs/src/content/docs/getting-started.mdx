...
description: Install and use inspect-value-element in your project
---
...
```bash
pnpm add inspect-value-element
yarn add inspect-value-element
bun add inspect-value-element
```
...
```html
<script type="module" src="https://unpkg.com/inspect-value-element"></script>
